 ...
 *     QUERY_VESC     0x83  — VESC controller status (6 controllers)
 *     QUERY_ARMS     0x84  — RoboClaw encoder counts (M1, M2)
 *
 ...
 *   TELEM_VESC     0x83  per controller × 6: [rpm:i32][cur:i16×10][vin:i16×10][tfet:i16×10][connected:u8] + CRC8  69 bytes
 *   TELEM_ARMS     0x84  [m1_enc:i32][m2_enc:i32][CRC8]                                         11 bytes
 *
 ...
 *
 *   TELEM_VESC per-controller layout (11 bytes each, 6 controllers = 66 bytes payload + 2 header + 1 CRC):
 *     [rpm:i32 LE][current:i16 LE, ×10][v_in:i16 LE, ×10][temp_fet:i16 LE, ×10][connected:u8]
 * ---------------------------------------------------------------------------
 */
...
#define QUERY_VESC      0x83U
#define QUERY_ARMS      0x84U
